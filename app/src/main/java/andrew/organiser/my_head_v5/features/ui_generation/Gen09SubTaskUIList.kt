...
class Gen09SubTaskUIList {

    companion object {

        private var lastChecklistId = 0
        private var globalSubtaskList: MutableList<SubtaskObject> = mutableListOf()
        private val subtaskWidgetIdList: MutableList<Array<Int>> = mutableListOf()

        // --- Sort UI Button List --- //
        fun createSubTaskList(c: Context, f: FragmentActivity, layout: ConstraintLayout, subtaskList: List<SubtaskObject>?, taskId: Int?){
            println("=== Gen09 - Create Subtask Button List for Task: $taskId ===")
        ...
        private fun createSubtaskItem(c: Context, f: FragmentActivity, layout: ConstraintLayout, subtaskObject: SubtaskObject?, taskId: Int?) : Int {
        ...
        private fun createGenericSubtaskNameEditText(c: Context) : EditText{
            ...
            checkItemName.layoutParams = params
        ...
        private fun createGenericSubtaskDateEditText(c: Context, f: FragmentActivity, nameEditTextId: Int) : EditText{
            ...
            Gen06TaskAddEditListeners.main(c, f, "setDateListeners", arrayListOf(checkItemDate), null)
        ...
        private fun createGenericSubtaskCheckBox(c: Context, enabledFlag: Boolean, nameEditTextId: Int) : CheckBox{
            ...
            completedCheckbox.layoutParams = params3
        ...
        private fun createGenericSubtaskButton(c: Context, backgroundResource: Int, buttonTagId: Int) : Button{
            ...
            subtaskButton.layoutParams = params4
        ...
        private fun setOnClickAddChecklistItem(c: Context, f: FragmentActivity, layout: ConstraintLayout, editName: EditText, editDate: EditText, checkBox: CheckBox, button: Button, taskId:Int?){
            ...
            button.setOnClickListener {
                ...
                if(newSubtaskName.isNotEmpty()){
                    ...
                    val newSubtaskModal = SubtaskObject(lastChecklistId, taskId?:0 ,newSubtaskName, newSubtaskDateStr, false)
                    lastChecklistId = createSubtaskItem(c, f, layout, null, taskId)
        ...
        private fun setOnClickRemoveChecklistItem(layout: ConstraintLayout, button: Button, nameEditText: EditText, dateEditText: EditText, checkBox: CheckBox){
            ...
            button.setOnClickListener {
                ...
                globalSubtaskList.forEach { subtask -> subtaskIdList.add(subtask.id) }
                val indexBtnTag = subtaskIdList.indexOf(button.tag)
                println("Process: Remove button Clicked: $indexBtnTag") //Process line
                ...
                //If not the topmost itself then topId is the id above this subtask, otherwise topId = 0
                ...
                println("Debug: topId: $topId and bottomId: $bottomId") //Debug line
                val constraintSet = ConstraintSet()
                constraintSet.clone(layout)
        ...
        fun getSaveSubtaskList(layout: ConstraintLayout, taskId: Int): ArrayList<SubtaskObject>{
            val updatedSubtaskList: ArrayList<SubtaskObject> = ArrayList()
            subtaskWidgetIdList.forEach { widgetIdArray ->
                ...
                if(subtaskName.isNotEmpty()){
                    ...
                    updatedSubtaskList.add(SubtaskObject(0, taskId, subtaskName, subtaskDate, checked))
                }
            }
